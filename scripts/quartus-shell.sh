...
# on the full 23.4 image also uses LM_LICENSE_FILE. Set both so the same
# interactive shell works across container versions — each tool picks the
# var it understands and ignores the other.
CONTAINER_ENV=(
