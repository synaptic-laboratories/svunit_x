...
Intel system is disabled. To activate:
  ...
  node /srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/get-shit-done/bin/gsd-tools.cjs
