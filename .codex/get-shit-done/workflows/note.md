...
- **Global scope**: `/srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/notes/`)
...
2. Glob `/srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/notes/` — works in any directory
