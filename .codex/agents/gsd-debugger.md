...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex
                  → checks /srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/get-shit-done
                  → writes to /srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/get-shit-done/hooks/
...
@/srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/get-shit-done/references/thinking-models-debug.md
...
- Read @/srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
