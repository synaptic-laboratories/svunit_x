...
Use template from `/srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
