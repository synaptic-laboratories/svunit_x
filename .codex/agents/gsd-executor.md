...
@/srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/get-shit-done/references/thinking-models-execution.md
...
**See @/srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/get-shit-done/references/checkpoints.md**
...
```bash
node /srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/get-shit-done/bin/gsd-tools.cjs commit-to-subrepo "{type}({phase}-{plan}): {concise task description}" --files file1 file2 ...
```
...
**Use template:** @/srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/get-shit-done/templates/summary.md
...
node "/srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap update-plan-progress "${PHASE_NUMBER}"
...
```bash
node "/srv/share/repo/pub/com/github/synaptic-laboratories/svunit_x/.codex/get-shit-done/bin/gsd-tools.cjs" state add-blocker "Blocker description"
```
</state_updates>
